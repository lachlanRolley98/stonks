...
output_file = os.path.join(output_folder, 'goodMovingAvg.csv')
...
# Filter the top 1% of stocks by RSI_DIFF
top_1_percent = good_stocks_df.nlargest(int(len(good_stocks_df) * 0.01), 'RSI_Diff')

# Save the filtered DataFrame to a CSV file
top_1_percent.to_csv(output_file, index=False)

print(f"Top 1% of stocks to consider buying have been saved to {output_file}")
